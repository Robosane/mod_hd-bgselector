...
'.$hdbg_id.' {background-image: url("'.$hdbg_baseurl.$root_image.$hdbg_image.'")'.$hdbg_importance.'; background-attachment:'.$hdbg_attachment.''.$hdbg_importance.'; background-position:'.$hdbg_position.''.$hdbg_importance.'; background-repeat:'.$hdbg_repeat.''.$hdbg_importance.'; background-color:'.$hdbg_color.''.$hdbg_importance.';}
...
$hdbg_one = 'url("'.$hdbg_baseurl.$root_image.$hdbg_image.'") ';
if (!empty($hdbg_image_two)) {$hdbg_two = ', url("'.$hdbg_baseurl.$root_image.$hdbg_image_two.'") ';};
if (!empty($hdbg_image_three)) {$hdbg_three = ', url("'.$hdbg_baseurl.$root_image.$hdbg_image_three.'") ';};
if (!empty($hdbg_image_four)) {$hdbg_four = ', url("'.$hdbg_baseurl.$root_image.$hdbg_image_four.'") ';};
if (!empty($hdbg_image_five)) {$hdbg_five = ', url("'.$hdbg_baseurl.$root_image.$hdbg_image_five.'") ';};
if (!empty($hdbg_image_six)) {$hdbg_six = ', url("'.$hdbg_baseurl.$root_image.$hdbg_image_six.'") ';};
if (!empty($hdbg_image_seven)) {$hdbg_seven = ', url("'.$hdbg_baseurl.$root_image.$hdbg_image_seven.'")';};
...
if ($randbg == 1) {$randimage = $hdbg_baseurl.$root_image.$hdbg_image;};
if ($randbg == 2) {$randimage = $hdbg_baseurl.$root_image.$hdbg_image_two;};
if ($randbg == 3) {$randimage = $hdbg_baseurl.$root_image.$hdbg_image_three;};
if ($randbg == 4) {$randimage = $hdbg_baseurl.$root_image.$hdbg_image_four;};
if ($randbg == 5) {$randimage = $hdbg_baseurl.$root_image.$hdbg_image_five;};
if ($randbg == 6) {$randimage = $hdbg_baseurl.$root_image.$hdbg_image_six;};
if ($randbg == 7) {$randimage = $hdbg_baseurl.$root_image.$hdbg_image_seven;};
...
if ($todaybg == 0) {$todayimage = $hdbg_baseurl.$root_image.$hdbg_image;};
if ($todaybg == 1) {$todayimage = $hdbg_baseurl.$root_image.$hdbg_image_two;};
if ($todaybg == 2) {$todayimage = $hdbg_baseurl.$root_image.$hdbg_image_three;};
if ($todaybg == 3) {$todayimage = $hdbg_baseurl.$root_image.$hdbg_image_four;};
if ($todaybg == 4) {$todayimage = $hdbg_baseurl.$root_image.$hdbg_image_five;};
if ($todaybg == 5) {$todayimage = $hdbg_baseurl.$root_image.$hdbg_image_six;};
if ($todaybg == 6) {$todayimage = $hdbg_baseurl.$root_image.$hdbg_image_seven;};
